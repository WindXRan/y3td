...
def build_reference_growth_weapon_slot():
    ...
    root["children"] = [
        image("slot_bg", 36, 36, 72, 72, SHOP_BG_ALT, [255, 255, 255, 210], True),
        image("slot_inner", 36, 36, 60, 60, BG_BLACK, [255, 255, 255, 138], True),
        image("frame", 36, 36, 62, 62, PROP_FRAME_ALT, [255, 255, 255, 255], False),
...
def build_reference_consumable_slot(name, x, y, hotkey, amount_text, icon_id):
    ...
    root["children"] = [
        image("slot_bg", 32, 27, 64, 54, SHOP_CONTENT_BG_ALT, [255, 255, 255, 214], True),
...
def build_bottom_hud():
    ...
    shell["children"] = [
        image("shell_bg", 815, 140, 1630, 280, BG_BLACK, [255, 255, 255, 236], True),
        image("shell_inner", 815, 140, 1612, 266, SHOP_CONTENT_BG_ALT, [255, 255, 255, 196], True),
        image("top_line", 815, 271, 1588, 2, SHOP_LINE, [255, 255, 255, 214], True),
    ]

    left_station = panel("left_station", 350, 148, 460, 268, [14, 18, 25, 92])
    left_station["children"] = [
        image("station_bg", 230, 134, 460, 268, SHOP_BG, [255, 255, 255, 220], True),
        image("station_inner", 230, 134, 444, 252, BG_BLACK, [255, 255, 255, 208], True),
        image("station_title_line", 230, 228, 420, 1, SHOP_LINE, [255, 255, 255, 182], True),
        image("map_frame", 118, 138, 214, 188, SHOP_BG_ALT, [255, 255, 255, 234], True),
        image("map_inner", 118, 138, 198, 172, BG_BLACK, [255, 255, 255, 206], True),
        image("map_badge_bg", 62, 240, 98, 24, SHOP_CONTENT_BG, [255, 220, 126, 238], True),
        text("map_badge", 62, 240, 84, 16, "第3赛季", 12, [255, 245, 206, 255]),
        image("mini_map", 118, 138, 186, 160, SHOP_CONTENT_BG_ALT, [255, 255, 255, 102], True),
    ...
    toggle_frame["children"] = [
        image("frame_bg", 158, 21, 316, 42, SHOP_BG_ALT, [255, 255, 255, 222], True),
        image("frame_inner", 158, 21, 300, 30, BG_BLACK, [255, 255, 255, 158], True),
    ...
    player_attr_list["children"] = [
        image("panel_bg", 99, 94, 198, 188, SHOP_BG_ALT, [255, 255, 255, 220], True),
        image("panel_inner", 99, 94, 184, 172, BG_BLACK, [255, 255, 255, 150], True),
    ...
    center_hub["children"] = [
        image("module_bg", 306, 134, 612, 268, SHOP_BG_ALT, [255, 255, 255, 220], True),
        image("module_inner", 306, 134, 596, 252, BG_BLACK, [255, 255, 255, 168], True),
    ]

    hero_panel = panel("hero_panel", 100, 134, 184, 214, [28, 32, 42, 92])
    hero_panel["children"] = [
        image("panel_bg", 92, 107, 184, 214, SHOP_BG, [255, 255, 255, 220], True),
        image("panel_inner", 92, 107, 168, 198, BG_BLACK, [255, 255, 255, 158], True),
    ...
    combat_module["children"] = [
        image("panel_bg", 200, 107, 400, 214, SHOP_BG, [255, 255, 255, 212], True),
        image("panel_inner", 200, 107, 384, 198, BG_BLACK, [255, 255, 255, 140], True),
    ]
    ...
    skill_bar["children"] = [
        image("bar_bg", 156, 36, 312, 72, SHOP_BG_ALT, [255, 255, 255, 210], True),
        image("bar_inner", 156, 36, 298, 58, BG_BLACK, [255, 255, 255, 132], True),
    ...
    right_station["children"] = [
        image("station_bg", 272, 134, 544, 268, SHOP_BG_ALT, [255, 255, 255, 224], True),
        image("station_inner", 272, 134, 528, 252, BG_BLACK, [255, 255, 255, 184], True),
        image("station_top_line", 272, 228, 504, 1, SHOP_LINE, [255, 255, 255, 176], True),
    ]

    loadout_row = panel("loadout_row", 98, 134, 156, 214, [17, 22, 31, 92])
    loadout_row["children"] = [
        image("panel_bg", 78, 107, 156, 214, SHOP_BG, [255, 255, 255, 218], True),
        image("panel_inner", 78, 107, 142, 198, BG_BLACK, [255, 255, 255, 150], True),
        image("title_bg", 46, 193, 92, 22, SHOP_CONTENT_BG, [110, 176, 255, 242], True),
        text("loadout_title", 46, 193, 78, 16, "物品栏", 12, [244, 249, 255, 255]),
    ]
    loadout_icons = [
        ICON_ITEM_2,
        ICON_ITEM_4,
    ...
    consumable_panel["children"] = [
        image("panel_bg", 36, 95, 72, 190, SHOP_BG, [255, 255, 255, 214], True),
        image("panel_inner", 36, 95, 60, 174, BG_BLACK, [255, 255, 255, 140], True),
    ...
    card_panel["children"] = [
        image("panel_bg", 124, 107, 248, 214, SHOP_BG_ALT, [255, 255, 255, 222], True),
        image("panel_inner", 124, 107, 234, 198, BG_BLACK, [255, 255, 255, 142], True),
        text("station_hint", 124, 194, 224, 14, "按F抽卡，相同羁绊自动吞噬", 10, [232, 236, 242, 255]),
