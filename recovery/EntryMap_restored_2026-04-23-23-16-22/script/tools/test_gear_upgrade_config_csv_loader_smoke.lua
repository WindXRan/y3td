...
assert(#cfg.affixes_by_pool.pool_10 == 9, 'pool_10 should load 9 affixes')
assert(cfg.affixes_by_pool.pool_10[1].quality == 'common', 'pool_10 should preserve common quality labels')
assert(cfg.affixes_by_pool.pool_10[4].quality == 'rare', 'pool_10 should preserve rare quality labels')
assert(cfg.affixes_by_pool.pool_10[7].quality == 'epic', 'pool_10 should preserve epic quality labels')
