...
def main() -> None:
    ...
    smoke_source = (
        ...
        "assert(hero_attr_system.get_attr(hero, '力量') == 70, 'first affix should add strength to the hero attr system') "
        "assert(hero_attr_system.get_attr(hero, '攻击结算值') > 124, 'derived attack value should increase after the strength affix') "
        "for _ = 1, 9 do "
