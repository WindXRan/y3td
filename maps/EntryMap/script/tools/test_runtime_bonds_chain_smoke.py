...
def main() -> None:
    ...
    smoke_source = (
            ...
            "assert(bonds.can_unlock_node(root_draw_state, 'bond_body_life') == true or bonds.can_unlock_node(root_draw_state, 'bond_body_tactics') == true or bonds.can_unlock_node(root_draw_state, 'bond_body_fortress') == true or bonds.can_unlock_node(root_draw_state, 'bond_body_charge_breaker') == true or bonds.can_unlock_node(root_draw_state, 'bond_body_blood_oath') == true or bonds.can_unlock_node(root_draw_state, 'bond_body_blood_demon') == true, 'body branches should appear only after base body set is complete') "
            ...
            "assert(string.find(agility_choice.title_text or '', '0/11', 1, true) ~= nil, 'growth branch root title should show its own branch progress instead of root set progress') "
            ...
            "assert(agility_choice.body_blocks[2] and agility_choice.body_blocks[2].kind == 'effect_title' and string.find(agility_choice.body_blocks[2].text or '', '套装效果', 1, true) ~= nil and string.find(agility_choice.body_blocks[2].text or '', '本卡', 1, true) == nil, 'branch choice should label advanced text as set effect instead of card effect') "
            "assert(agility_choice.body_blocks[3] and (agility_choice.body_blocks[3].text or '') ~= '', 'branch choice should show its own advanced text') "
            ...
            "end "
            "assert(moon_blade_index ~= nil, 'archery barrage unlock should expose second barrage card candidate') "
            ...
            "assert(moon_blade_choice.node_id == 'bond_archery_barrage_moon_blade', 'forced archery draw should pick the second barrage card') "
            "assert(string.find(moon_blade_choice.title_text or '', '1/4', 1, true) ~= nil, 'barrage branch title should show current branch-chain progress instead of completed root-set progress') "
            "assert(string.find(moon_blade_choice.title_text or '', '箭术', 1, true) == nil, 'barrage branch title should not fall back to root-set title text') "
            ...
            "assert(bonds.unlock_node(magic_draw_state, 'bond_magic_haste_cooldown')) "
            "assert(bonds.unlock_node(magic_draw_state, 'bond_magic_haste_charge')) "
            ...
            "assert(string.find(mage_choice.title_text or '', '1/4', 1, true) ~= nil, 'mage title should show current branch-chain progress instead of completed root-set progress') "
