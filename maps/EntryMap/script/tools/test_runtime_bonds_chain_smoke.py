...
def main() -> None:
    ...
    smoke_source = (
            ...
            "assert(string.find(defs.bond_growth_bow_god.desc.advanced, '最终敏捷+5%', 1, true) ~= nil and string.find(defs.bond_growth_bow_god.desc.advanced, '每点敏捷额外提供5攻击力', 1, true) ~= nil and string.find(defs.bond_growth_bow_god.desc.advanced, '继续补齐', 1, true) == nil, '弓神套装文案应同步总表正式效果') "
            ...
            "assert(string.find(defs.bond_growth_war_god.desc.advanced, '最终力量+5%', 1, true) ~= nil and string.find(defs.bond_growth_war_god.desc.advanced, '每点力量额外提供5攻击力', 1, true) ~= nil and string.find(defs.bond_growth_war_god.desc.advanced, '继续补齐', 1, true) == nil, '战神套装文案应同步总表正式效果') "
            ...
            "assert(string.find(defs.bond_growth_spell_god.desc.advanced, '最终智力+5%', 1, true) ~= nil and string.find(defs.bond_growth_spell_god.desc.advanced, '每点智力额外提供5攻击力', 1, true) ~= nil and string.find(defs.bond_growth_spell_god.desc.advanced, '继续补齐', 1, true) == nil, '法神套装文案应同步总表正式效果') "
