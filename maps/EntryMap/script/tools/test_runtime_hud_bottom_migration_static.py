...
def main() -> None:
    ...
    for needle, message in [
        ...
        ("slot_ui = try_create_child_ui(anchor, '物品')", 'expected bottom inventory slots to create equip-slot components'),
        ('local function ensure_bottom_inventory_slots(runtime_hud)', 'expected bottom inventory slot bootstrap'),
        ...
        ('slot_ui = runtime_hud.editor_bottom_inventory_slots[slot]', 'expected equipment binding to use bottom equip-slot components'),
