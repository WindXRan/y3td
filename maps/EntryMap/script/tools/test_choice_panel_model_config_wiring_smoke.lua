...
assert(bond_panel.cards[1].tip_model.set_title_text == '套装效果：', 'tip model should map advanced text into the set-effect section')
...
assert(bond_panel.cards[1].item_desc_payload.affix_lines[1].title == '3件效果', 'bond item desc should label the explanation area as the set completion effect')
