...
def main() -> None:
    smoke = (
        ...
        "assert(profile.hero_attr_bonus_stats['攻击白字'] == 6, 'expected cleared standard stage attack bonus to apply') "
        "assert(profile.hero_attr_bonus_stats['生命白字'] == 120, 'expected cleared standard stage hp bonus to apply') "
