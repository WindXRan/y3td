...
def main() -> None:
    smoke = (
        ...
        "  CONFIG = { "
        "    stages = { list = { "
        "      { stage_id = '1-1', display_name = '主线 1-1', mode_ids = { 'standard', 'challenge' }, content_source_stage_id = '1-1' }, "
        "      { stage_id = '1-2', display_name = '主线 1-2', mode_ids = { 'standard', 'challenge' }, content_source_stage_id = '1-2' } "
        "    }, by_id = { "
        "      ['1-1'] = { stage_id = '1-1', display_name = '主线 1-1', mode_ids = { 'standard', 'challenge' }, content_source_stage_id = '1-1' }, "
        "      ['1-2'] = { stage_id = '1-2', display_name = '主线 1-2', mode_ids = { 'standard', 'challenge' }, content_source_stage_id = '1-2' } "
        "    } }, "
        "    stage_modes = { by_id = { "
