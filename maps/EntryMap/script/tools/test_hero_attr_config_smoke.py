...
def main() -> None:
    smoke = (
        ...
        "assert(cfg.hero_init_stats['攻击白字'] == 60) "
        ...
        "assert(cfg.hero_init_stats['生命白字'] == 600) "
        "assert(cfg.hero_init_stats['护甲白字'] == 6) "
        "assert(cfg.hero_init_stats['生命绿字'] == 0) "
        "assert(cfg.hero_init_stats['力量白字'] == 10) "
        "assert(cfg.hero_init_stats['力量绿字'] == 0) "
        "assert(cfg.hero_init_stats['敏捷白字'] == 10) "
        "assert(cfg.hero_init_stats['敏捷绿字'] == 0) "
        "assert(cfg.hero_init_stats['智力白字'] == 10) "
