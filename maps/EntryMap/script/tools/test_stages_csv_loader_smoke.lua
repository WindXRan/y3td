...
assert(stage_5_15.mode_ids[1] == 'standard', 'stage 5-15 should keep standard mode first')
assert(stage_5_15.mode_ids[2] == 'challenge', 'stage 5-15 should keep challenge mode second')
