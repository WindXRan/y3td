...
function M.create(env)
  ...
  local function create_overview_panel()
    ...
    local sections = {
      ...
      bonds = create_section(root, scaled(36, scale), scaled(34, scale), scaled(592, scale), scaled(206, scale), '仙缘道统'),
      ...
      progress = create_section(root, scaled(672, scale), scaled(34, scale), scaled(592, scale), scaled(206, scale), '道统进境'),
    }
