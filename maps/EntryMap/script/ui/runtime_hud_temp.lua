...
function e.create(v)
  ...
  local function aE(u, aF)
    ...
    if aF.background then a6(u, 'set_show_room_background_color', aF.background[1], aF.background[2], aF.background[3],
        aF.background[4] or 0) end
  end;
  ...
  local function bi() return w.gear_state and w.gear_state.items and w.gear_state.items.weapon and
  ...
  local function cC() return table.concat(
  ...
  local function cD()
    ...
    if t(a0.bond_tip_panel) then
      if not t(a0.bond_tip_icon) then a0.bond_tip_icon = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.layout_3.image_1') end;
      if not t(a0.bond_tip_set_title) then a0.bond_tip_set_title = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.layout_3.标题_1') end;
      ...
      if not t(a0.bond_tip_detail_body) then a0.bond_tip_detail_body = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.详情效果内容') end;
      if not t(a0.bond_tip_special_title) then a0.bond_tip_special_title = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.特殊效果标题') end;
      if not t(a0.bond_tip_special_body) then a0.bond_tip_special_body = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.特殊效果内容') end;
      if not t(a0.bond_tip_skill_title) then a0.bond_tip_skill_title = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.技能效果') end;
      if not t(a0.bond_tip_skill_body) then a0.bond_tip_skill_body = a.resolve_child(a0.bond_tip_panel,
          'scroll_view.技能效果内容') end;
    end;
  ...
  local function dW()
    for bL = 1, g do
      ...
      local dr = Z(cJ .. '.icon')
      local dq = Q and Q(bL) or nil
      local slot_ui = Z(cJ)

      a9(slot_ui, bL <= 7 or bL == 8)
      if dq then
        a9(dr, true)
        ak(dr, dq)
      else
