...
| `try_upgrade_growth_weapon()` | 1037 | 尝试升级成长武器（首次懒创建 BattleEventPrompts） | `_G.try_upgrade_growth_weapon` |
...
| 模块 | 位置 | 导出 | 职责 |
|------|------|------|------|
| `auto_active_effects` | 1120 | `_G.auto_active_effects_system` | 自动激活效果系统 |
| `effect_debug` | 1123 | `_G.effect_debug_system` | 特效调试 |
...
| `growth_weapon_item_tip` | 1150 | `_G.growth_weapon_item_tip` | 成长武器物品提示 |
