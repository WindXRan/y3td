...
M.list = {
  define('攻击', M.categories.DAMAGE, 10, 'integer'),
  ...
  define('生命', M.categories.DEFENSE, 10, 'integer'),
  define('护甲', M.categories.DEFENSE, 20, 'integer'),
  ...
  define('力量', M.categories.AMPLIFY, 10, 'integer'),
  define('敏捷', M.categories.AMPLIFY, 20, 'integer'),
  define('智力', M.categories.AMPLIFY, 30, 'integer'),
  ...
  define('物系伤害', M.categories.OTHER, 10, 'percent', { is_ratio = true }),
  define('火系伤害', M.categories.OTHER, 20, 'percent', { is_ratio = true }),
  define('电系伤害', M.categories.OTHER, 30, 'percent', { is_ratio = true }),
  ...
  define('能量伤害', M.categories.OTHER, 80, 'percent', { is_ratio = true }),
  define('冰系伤害', M.categories.OTHER, 90, 'percent', { is_ratio = true }),
  define('风系伤害', M.categories.OTHER, 100, 'percent', { is_ratio = true }),
