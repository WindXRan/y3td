...
function M.create(args)
  ...
  local function create_skill_runtime()
    local runtime = copy_fields(SHARED_RUNTIME_FIELDS)
    runtime.normal_attack_bonus_ratio = 0
    runtime.splash_ratio = 0
    runtime.splash_radius = 220
    runtime.chain_chance = 0
    runtime.chain_bounces = 0
    runtime.chain_ratio = 0
    runtime.chain_radius = 420
    runtime.execute_threshold = 0
    runtime.medbot_every = 0
    runtime.medbot_heal = 0
    runtime.medbot_kills = 0
    runtime.artillery_interval = 0
    runtime.artillery_ratio = 0
    runtime.artillery_base = 0
    runtime.artillery_radius = 0
    runtime.artillery_cd = 0
    runtime.bonus_gold_on_kill = 0
    return runtime
  end
