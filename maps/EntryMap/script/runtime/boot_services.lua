...
M.attack_skills_system_setter = create_service_slot('attack_skills_system')
M.auto_active_effects_system_setter = create_service_slot('auto_active_effects_system')
M.effect_debug_system_setter = create_service_slot('effect_debug_system')
M.runtime_ui_helpers_setter = create_service_slot('runtime_ui_helpers')
M.result_panel_system_setter = create_service_slot('result_panel_system')
M.battle_auto_acceptance_system_setter = create_service_slot('battle_auto_acceptance_system')
...
function M.sync_services(RuntimeEntry)
    ...
    RuntimeEntry._services.attack_skills_system = services.attack_skills_system()
    RuntimeEntry._services.auto_active_effects_system = services.auto_active_effects_system()
    RuntimeEntry._services.effect_debug_system = services.effect_debug_system()
    RuntimeEntry._services.runtime_ui_helpers = services.runtime_ui_helpers()
    RuntimeEntry._services.result_panel_system = services.result_panel_system()
    RuntimeEntry._services.battle_auto_acceptance_system = services.battle_auto_acceptance_system()
