...
function M.create(env)
  ...
  local SAMPLE_VISUALS = {
    arrow_rain = {
      ...
      projectile_key = bond_projectile('游侠', PROJECTILES['多重箭']),
    ...
    line_lance = {
      ...
      projectile_key = bond_projectile('龙骑士', PROJECTILES['火球']),
      projectile_time = 1.05,
    ...
    meteor_grid = {
      ...
      projectile_key = bond_projectile('火法师', PROJECTILES['陨石']),
    ...
    chain_arc = {
      ...
      projectile_key = bond_projectile('雷电法王', PROJECTILES['连锁闪电']),
    ...
    fan_barrage = {
      ...
      projectile_key = bond_projectile('神射手', PROJECTILES['疾风箭']),
    ...
    burn_field = {
      ...
      hit = bond_particle('火法师', fx.flame_impact),
      projectile_key = bond_projectile('火法师', PROJECTILES['莲火']),
    ...
    boomerang_blade = {
      ...
      projectile_key = bond_projectile('剑宗', PROJECTILES['月刃']),
      projectile_time = 0.82,
      projectile_height = 18,
    },
    mark_execute = {
      ...
      projectile_key = bond_projectile('魔剑士', PROJECTILES['恶魔封印']),
  ...
  local CLOUD_VFX_PACKS = {
    production_v2 = {
      arrow_rain = { warning = 106060, cast = 106060, impact = 106090, hit = 106069, projectile_key = PROJECTILES['多重箭'], projectile_time = 0.64, projectile_height = 22 },
      ...
      line_lance = { warning = 106089, cast = 106089, impact = 106081, hit = 106053, projectile_key = PROJECTILES['火球'], projectile_time = 0.90, projectile_height = 28 },
      meteor_grid = { warning = 106082, cast = 106082, impact = 106089, hit = 106053, projectile_key = PROJECTILES['陨石'], projectile_time = 1.02, projectile_height = 36 },
      ...
      chain_arc = { warning = 106074, cast = 106074, impact = 106112, hit = 106074, projectile_key = PROJECTILES['连锁闪电'], projectile_time = 0.74, projectile_height = 24 },
      fan_barrage = { warning = 106090, cast = 106060, impact = 106069, hit = 106060, projectile_key = PROJECTILES['疾风箭'], projectile_time = 0.62, projectile_height = 14 },
      burn_field = { warning = 106082, cast = 106053, impact = 106081, hit = 106053, projectile_key = PROJECTILES['莲火'], projectile_time = 0.82, projectile_height = 18 },
      boomerang_blade = { warning = 106092, cast = 106109, impact = 106092, hit = 106109, projectile_key = PROJECTILES['月刃'], projectile_time = 0.72, projectile_height = 16 },
      mark_execute = { warning = 106107, cast = 106056, impact = 106107, hit = 106056, projectile_key = PROJECTILES['恶魔封印'], projectile_time = 0.78, projectile_height = 20 },
    },
  }
  ...
  local function add_diablo_like_skill_samples()
    ...
    local function register_and_cast(profile)
      ...
      if not def then
        return false, string.format('构建失败：%s', tostring(profile.id))
      end
      local ok, reason = skill_framework.register(def)
      if not ok then
        return false, tostring(reason or 'register failed')
    ...
    local profiles = {
      {
        id = '裂地重斩',
        name = '裂地重斩',
        desc = '猛力劈向前方，对范围敌人造成[攻击力×220% + 力量×6]点物理伤害。冷却[8秒]。',
      ...
      },
      {
        id = '血怒处决',
        name = '血怒处决',
        desc = '撕裂目标造成[攻击力×180% + 力量×5]点物理伤害。冷却[10秒]。',
      ...
      },
      {
        id = '猛冲践踏',
        name = '猛冲践踏',
        desc = '猛冲并践踏地面，路径与落地点造成物理伤害。主段系数[攻击力×180% + 力量×5]。冷却[12秒]。',
      ...
      },
      {
        id = '穿心连射',
        name = '穿心连射',
        desc = '连续射出多支箭矢，每次命中造成[攻击力×55% + 敏捷×2]点物理伤害。冷却[9秒]。',
      ...
      },
      {
        id = '回旋刃阵',
        name = '回旋刃阵',
        desc = '投出回旋飞刃，每次命中造成[攻击力×95% + 敏捷×3]点物理伤害。冷却[11秒]。',
      ...
      },
      {
        id = '影步断喉',
        name = '影步断喉',
        desc = '连斩两段伤害：主段[攻击力×200% + 敏捷×6]，追击段[攻击力×80% + 敏捷×2]。冷却[13秒]。',
        visual_ref = 'mark_execute',
        base_id = 'sf_area_burst',
        tier = 'heavy',
        pattern = 'area_burst',
      ...
      },
      {
        id = '毒雾箭雨',
        name = '毒雾箭雨',
        desc = '持续箭雨每跳造成[攻击力×45% + 敏捷×1]点物理伤害。冷却[15秒]。',
      ...
      },
      {
        id = '陨火术',
        name = '陨火术',
        desc = '陨火命中造成[法术强度×280% + 智力×6]点法术伤害，并留下燃烧区。冷却[12秒]。',
      ...
      },
      {
        id = '冰环禁锢',
        name = '冰环禁锢',
        desc = '冻结周围敌人并造成[法术强度×170% + 智力×4]点法术伤害。冷却[14秒]。',
        visual_ref = 'blizzard',
        base_id = 'sf_area_burst',
        tier = 'mid',
        pattern = 'area_burst',
      ...
      },
      {
        id = '连锁雷矛',
        name = '连锁雷矛',
        desc = '首段造成[法术强度×190% + 智力×5]点法术伤害，最多弹射[4]次，每跳[85%]衰减。冷却[9秒]。',
      ...
      },
      {
        id = '奥术召唤阵',
        name = '奥术召唤阵',
        desc = '召唤奥术仆从作战（样例以法阵爆裂模拟），造成[法术强度×120% + (力量+智力+敏捷)×1.5]点法术伤害。冷却[20秒]。',
      ...
      },
      {
        id = '奥术仆从爆裂',
        name = '奥术仆从爆裂',
        desc = '召唤物死亡爆裂（样例独立施放），造成[法术强度×120% + (力量+智力+敏捷)×1.5]点范围法术伤害。冷却[20秒]。',
        visual_ref = 'void_pulse',
        base_id = 'sf_area_burst',
        tier = 'mid',
        pattern = 'area_burst',
