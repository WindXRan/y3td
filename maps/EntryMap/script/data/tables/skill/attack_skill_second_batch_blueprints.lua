...
local meta_rows = CsvLoader.read_rows_optional({path = 'data_csv/attack_skill_second_batch_meta.csv'})
local lane_rows = CsvLoader.read_rows_optional({path = 'data_csv/attack_skill_second_batch_growth_lanes.csv'})
local skill_rows = CsvLoader.read_rows_optional({path = 'data_csv/attack_skill_second_batch_skills.csv'})
local evolution_rows = CsvLoader.read_rows_optional({path = 'data_csv/attack_skill_second_batch_evolutions.csv'})
local card_rows = CsvLoader.read_rows_optional({path = 'data_csv/attack_skill_second_batch_cards.csv'})
