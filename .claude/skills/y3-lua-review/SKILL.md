...
```
1. .claude/rules/api-safety.mdc          ← API 安全规则 + 常见错误速查
2. .claude/memory/lua-issues/api_issues.md ← 已知 API 错误模式（当前 10 条）
3. .claude/memory/lua-issues/trace_issues.md ← 运行时 trace 错误（如存在）
```
